...
for state in [state for state in set(wnv_data['state']) if state != 'DC']:
    ...
    state_data.dropna(inplace=True)
    state_data.to_csv('statesExtended/' + state.strip() + '/withAllInputs_' + state.strip() + '.csv')
    ...
    combined.to_csv('statesExtended/' + state.strip() + '/withAllInputs_powerTransformed_' + state.strip() + '.csv')
    ...
    state_data_weather.to_csv('statesExtended/' + state.strip() + '/withWeatherInputs_' + state.strip() + '.csv')
    state_data_age.to_csv('statesExtended/' + state.strip() + '/withAgeInputs_' + state.strip() + '.csv')
    state_data_race.to_csv('statesExtended/' + state.strip() + '/withRaceInputs_' + state.strip() + '.csv')
    state_data_temporal.to_csv('statesExtended/' + state.strip() + '/withTemporalInputs_' + state.strip() + '.csv')
    ...
    state_data_weather_powerTransformed.to_csv('statesExtended/' + state.strip() + '/withWeatherInputs_powerTransformed_' + state.strip() + '.csv')
    state_data_age_powerTransformed.to_csv('statesExtended/' + state.strip() + '/withAgeInputs_powerTransformed_' + state.strip() + '.csv')
    state_data_race_powerTransformed.to_csv('statesExtended/' + state.strip() + '/withRaceInputs_powerTransformed_' + state.strip() + '.csv')
    state_data_temporal_powerTransformed.to_csv('statesExtended/' + state.strip() + '/withTemporalInputs_powerTransformed_' + state.strip() + '.csv')
