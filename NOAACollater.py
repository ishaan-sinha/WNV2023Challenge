...
for i in range(41, 49):
    driver.get("https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/statewide/time-series/"+ str(i) +"/zndx/all/12/1990-2022?base_prd=true&begbaseyear=1901&endbaseyear=2000")
    state = stateDict[i]
    time.sleep(5)
    ...
    noaa_data.to_csv('states/' + state+'/' + state + '_zindex_data.csv')
