...
#for state in ['CA']:
    ...
    #plt.show()
    plt.savefig('../statesOctoberSubmission/'+state+'/train+testBase.png')
    plt.clf()
    ts_pred = transformer.inverse_transform(ts_tpred)
    ...
    #plt.show()
    plt.savefig('../statesOctoberSubmission/'+state+'/testBase.png')
    plt.clf()
...
df_results_mae.to_csv('../modelResults/October/baselineWithNationalTest.csv')
