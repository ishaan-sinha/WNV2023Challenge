...
#for state in ['CA']:
    ...
    rando_data = state_data[state_data['8monthsAhead'].notna()]

    #We will make 8 forecasts, as we have 8 months ahead for the rest of the data
    ts = TimeSeries.from_series(rando_data['8monthsAhead'])
    ...
    dfY = dfY[-8:]
    dfY.to_csv('../statesJuneSubmission/'+state+'/FORECASTwithArbovirusLocalizedMinMax.csv')
    print(state)
